    ...
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">
          Analyse IQA par Métropole
        </h2>
        <p className="text-gray-600">
          Surveillance en temps réel de la qualité de l'air dans les grandes
          villes françaises
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 h-[calc(100vh-12rem)]">
        ...
        <div className="xl:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 h-[calc(100vh-12rem)] flex flex-col overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        ...
                        style={{ color: city.airQuality.color }}
                      >
            ...
            {selectedCity ? (
              <div className="space-y-6">
                ...
                <div
                  ...
                  style={{
                    backgroundColor: `${selectedCity.airQuality.color}15`,
                  }}
                >
                  <div className="flex items-center gap-2 mb-2">
                    <Wind
                      className="w-5 h-5"
                      style={{ color: selectedCity.airQuality.color }}
                    />
                    <span
                  ...
                  <div className="flex items-center gap-1 mt-2">
                    ...
                    <span
                      className={`text-xs ${getTrendColor(
                        selectedCity.airQuality.trend
                      )}`}
                    >
                      Tendance{" "}
                      {selectedCity.airQuality.trend === "improving"
                        ? "positive"
                        : selectedCity.airQuality.trend === "worsening"
                        ? "négative"
                        : "stable"}
                    </span>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium">
                        {selectedCity.airQuality.pollutants.pm25} µg/m³
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">PM10</span>
                      <span className="font-medium">
                        {selectedCity.airQuality.pollutants.pm10} µg/m³
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">NO₂</span>
                      <span className="font-medium">
                        {selectedCity.airQuality.pollutants.no2} µg/m³
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">O₃</span>
                      <span className="font-medium">
                        {selectedCity.airQuality.pollutants.o3} µg/m³
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart
                        data={[
                          {
                            name: "PM2.5",
                            value: selectedCity.airQuality.pollutants.pm25,
                          },
                          {
                            name: "PM10",
                            value: selectedCity.airQuality.pollutants.pm10,
                          },
                          {
                            name: "NO₂",
                            value: selectedCity.airQuality.pollutants.no2,
                          },
                          {
                            name: "O₃",
                            value: selectedCity.airQuality.pollutants.o3,
                          },
                        ]}
                      >
                        ...
                        <Bar
                          dataKey="value"
                          fill={selectedCity.airQuality.color}
                        />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                ...
                <div>
                  ...
                  <div className="h-32">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart
                        data={selectedCity.airQuality.historicalData.slice(-7)}
                      >
                        <CartesianGrid strokeDasharray="3 3" />
                        <XAxis
                          dataKey="date"
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <p>
                      ...
                      {new Date(
                        selectedCity.airQuality.lastUpdated
              ...
              <div className="text-center text-gray-500 mt-8">
                ...
                <p>
                  Sélectionnez une ville pour voir l'analyse détaillée de la
                  qualité de l'air
                </p>
              </div>
            )}
